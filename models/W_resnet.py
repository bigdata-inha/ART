...
class WideResNet(nn.Module):
    ...
    def forward(self, x, feature_return=False):
        ...
        temp_out = out.view(out.size(0), -1)
        out = out.view(-1, self.nChannels)

        feature = temp_out / torch.norm(out, 2, 1).unsqueeze(1)
...
def wideresnet_cl(depth=40, num_classes=100, EX_widen_factor=2, widen_factor=2, dropRate=0.0):
    return WideResNet_CL(depth=depth, num_classes=num_classes, EX_widen_factor=EX_widen_factor,
